...
ft_wordcount.c ft_sqrt.c ft_iswhitespace.c ft_intlen.c ft_hypotenuse.c \
...
ft_lstiter.o ft_memalloc.o ft_memccpy.o ft_memchr.o ft_memcmp.o \
...
ft_wordcount.o ft_sqrt.o ft_iswhitespace.o ft_intlen.o ft_hypotenuse.o \
